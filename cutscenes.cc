...
void cutscene_intro(Player* p) {
    ...
    text.print("Hamilton: I second it!");
    text.print("Thomas Jefferson, skeptical, chimes in.");
    text.print("Jefferson: This is lunacy, George! Without a solid plan, we're doomed to fail.");
    text.print("George: I will doom you to bachelorhood if you continue speaking.");
    ...
    text.print("Adams: Enough! I am aware your mother dropped you as child but thats no reason to act like buffoons.");
    ...
    text.print("George with patriotic zest: I want to give King George the American special!");
...
void cutscene_harbor(Player* p) {
    ...
    text.print("Adams visibly exhausted: You've said that about every ship today. Can you please just pick one?");
	text.print("Enchanted by the allure of danger george’s heart gets captured by the biggest behemoth in the harbor.");
	text.print("Its towering silhouette looms large,  casting an imposing shadow over the bustling dockyard.");
	text.print("Etched on the side of the ship was its name “Big Mom “.");
    text.print("George looks towards the monstrous beauty that is gaurded by the red coats..");
    text.print("George: Mama’s calling and ill be damned to apples ecosystem if i dont respond");
    text.print("Jefferson: Uh, are you sure that one-?");
    text.print("George, full of fervor, charges headlong towards the ship.");
    text.print("George: LEROY JENKINS!");
    George.moveChar(RIGHT, 33, 50);
    text.print("The Readcoats take notice of George.");
    text.print("Redcoats: HALT! ye corn-faced fiends");
    text.print("George: NAY! I will claim this vessel. My men push for Democracy, for Freedom, for Harambe!");
...
void cutscene_ocean(Player* p) {
    ...
    text.print("Adams: We forgot Hamilton!");
    text.print("George: Who?");
    text.print("Adams: Alexander Hamilton, our mate.");
    text.print("George dismissively: Oh him, we'll get him a souviner.");
    ...
    text.print("Jefferson: George do you think we can beat him?");
    text.print("George: If he is a true gentlmen he might cause me some trouble.");
	text.print("Jefferson: So would you lose?");
	text.print("George: Nah I'd win");
    text.print("Davy: What are you gentlemen discussing.");
	text.print("George: A gentlemens etiquette , not a topic suitable for an octopus");
	text.print("Davy: Huzaah, I will not let you taint my honor.");
    ...
    text.print("Davy: Rahh, I lost my dignity, my honor.");
    text.print("Adams: Stand proud, you are a true gentlemen.");
    text.print("Davy: You are right this is unsightly from me.");
    text.print("Adams: How about a rematch after you guide us to the king?");
    text.print("Davy: Hmm.. you won't kill him, will you?");
    text.print("Adams: No, I swear on George Washington's mother we shall only talk.");
    text.print("Davy: Fine, since this is your victory I shall trust you.");
    text.print("Adams: Thank you.");
...
void cutscene_castle_harbor(Player* p) {
    ...
    text.print("George: To end the British occupation for our FREEDOM!");
    p->currmap->scene_data.insert(make_pair(Benjamin.charLetter, make_pair(Benjamin.yPos, Benjamin.xPos)));
    p->currmap->scene_data.insert(make_pair(Jefferson.charLetter, make_pair(Jefferson.yPos, Jefferson.xPos)));
    p->currmap->scene_data.insert(make_pair(Adams.charLetter, make_pair(Adams.yPos, Adams.xPos)));
    text.delwin();
...
void cutscene_castle_harbor2(Player* p) {
    ...
    text.print("George: This can not stop me, I can't read.");
    text.delwin();
    p->display();
}
...
void cutscene_castle_outside(Player* p) {
    ...
    text.print("George: One, two, three. We will drink tea. Four, five, six. We will burry you in a ditch.");
...
void cutscene_castle(Player* p) {
	...
	text.print("The hallways echo with the condemning sound of silence.");
    text.print("His arrogance palpable as he sneers.");
    text.print("King George: Fear me and my wrath. My era shall not come to an end by-");
    text.print("Without hesitation, George Washington steps foward.");
    George.moveChar(RIGHT, 7, 100);
    text.print("He then raises his weapon and fires, silencing the tyrant during his speech.");
    text.print("BANG!");
    ...
    text.print("Adams: Maybe the real liberty was the friends we made along the way.");
